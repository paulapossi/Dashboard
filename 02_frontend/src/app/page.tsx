...
import MentalWidget from "@/components/dashboard/MentalWidget"; // NEU
...
const initialData = [
    ...
    { id: "mental", label: "Mental", progress: 100, color: "purple" }, // Wird jetzt durch Widget ersetzt
];
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="xl:col-span-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {categories.map((cat) => {
                            ...
                            if (cat.id === "sport") return <div key={cat.id} className={wrapperClass}><SportWidget /></div>;
                            if (cat.id === "lesen") return <div key={cat.id} className={wrapperClass}><ReadingWidget /></div>;
